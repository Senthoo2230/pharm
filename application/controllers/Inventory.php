...
class Inventory extends CI_Controller {
    ...
    public function insert(){
        ...
        $this->form_validation->set_rules('item_sub_catogery', 'Item sub category', 'required');
        $this->form_validation->set_rules('item_brand', 'Brand', 'required');
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $result = $this->Inventory_model->insert_item($id,$name,$cat,$subcat,$filter_range,$capacity,$part_number,$brand);
    ...
    public function add_frange(){
        $catogery = $this->input->post('catogery');
        $frange = $this->input->post('filter_range');
        $this->Inventory_model->insert_filter_range($catogery,$frange);
    ...
    public function add_brand(){
        ...
        $this->Inventory_model->insert_brand($catogery,$brand);
